...
export const techProducts = [
  ...
  },
  {
    ...
    optionGroups: [
      ...
      { name: '颜色', values: ['玫瑰金色', '银色', '亮黑色', '深空灰', '自然钛金属', '金色钛金属', '板岩色钛金属'] },
  ...
  },
  {
    ...
    shortDescription: 'iPad Pro 样图，尺寸、内存、颜色和连接方式可选，按官网价免税购买。',
    description: 'iPad Pro 可按尺寸、内存、颜色和连接方式组合加入购买清单，适合学习、绘图、影音和轻办公。',
    reminder: '页面价格为官网起售价，具体配置价格按 Apple 官网对应价格计算。',
  },
  {
