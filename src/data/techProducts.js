...
export const techProducts = [
  {
    ...
    optionGroups: [
      ...
      { name: '颜色', values: ['银色', '深色', '橙色', '其他颜色微信确认'] },
      { name: '版本', values: ['无锁版', '运营商版本需确认'] },
    ],
    shortDescription: 'iPhone 17 Pro 系列，机型、容量、颜色和库存请微信确认。',
    description: '适合想要最新 Pro 系列影像、性能和高刷新率体验的用户。可按机型、容量、颜色组合询价。',
    reminder: 'iPhone 价格和库存变化较快，下单前请微信确认具体机型、颜色、容量和是否无锁。',
  },
  {
    id: 'tech-iphone-air',
    section: 'Tech',
    ...
    optionGroups: [
      ...
      { name: '颜色', values: ['浅色', '深色', '其他颜色微信确认'] },
      { name: '版本', values: ['无锁版', '运营商版本需确认'] },
    ],
    shortDescription: 'iPhone Air 轻薄款，颜色、容量和库存请微信确认。',
    description: '适合想要轻薄机身、日常使用和苹果生态体验的用户。',
    reminder: '手机类请确认是否无锁、颜色、容量和预计到货时间。',
  },
  {
    id: 'tech-iphone-17',
    section: 'Tech',
    ...
    optionGroups: [
      ...
      { name: '颜色', values: ['黑色', '白色', '蓝色', '粉色', '其他颜色微信确认'] },
      { name: '版本', values: ['无锁版', '运营商版本需确认'] },
    ],
    shortDescription: 'iPhone 17 标准款，适合日常主力机，容量和颜色请微信确认。',
    description: '适合日常使用、拍照、学习和社交，配置更均衡。',
    reminder: '价格会随渠道和库存变化，请以当天微信确认为准。',
  },
  {
    id: 'tech-iphone-17e',
    section: 'Tech',
    ...
    optionGroups: [
      ...
      { name: '颜色', values: ['黑色', '白色', '其他颜色微信确认'] },
      { name: '版本', values: ['无锁版', '运营商版本需确认'] },
    ],
    shortDescription: 'iPhone 17e 入门新款，适合预算更稳的用户。',
    description: '适合日常通讯、拍照、学习和轻度娱乐，具体配置和库存请微信确认。',
    reminder: '手机类请确认无锁状态和容量，预订商品需先确认到货时间。',
  },
  {
    id: 'tech-ipad-air',
    section: 'Tech',
    ...
    optionGroups: [
      ...
      { name: '颜色', values: ['蓝色', '紫色', '星光色', '深空灰', '其他颜色微信确认'] },
    ],
    shortDescription: 'iPad Air 新款，适合上课笔记、PDF、影音和轻办公。',
    description: 'iPad Air 适合留学生上课记笔记、阅读 PDF、看剧和轻办公，可按尺寸、容量和连接方式询价。',
    reminder: 'iPad 类请确认尺寸、容量、连接方式和颜色，价格以微信确认为准。',
  },
  {
    id: 'tech-ipad',
    section: 'Tech',
  ...
  },
  {
    ...
    optionGroups: [
      ...
      { name: '颜色', values: ['银色', '星光色', '深空灰', '其他颜色微信确认'] },
    ],
  ...
  },
  {
    ...
    optionGroups: [
      ...
      { name: '颜色', values: ['午夜色', '星光色', '银色', '深空灰', '其他颜色微信确认'] },
    ],
  ...
  },
  {
    ...
    description: '适合专业学习、编程、视频剪辑、设计和多任务工作，具体芯片和配置请微信确认。',
  ...
  },
  {
    ...
    description: '适合视频、3D、设计、音乐制作和专业工作流，具体配置请微信确认。',
  ...
  },
  {
    ...
    description: '适合桌面办公、设计和苹果生态用户，具体版本和支架配置请微信确认。',
  ...
  },
  {
    ...
    shortDescription: 'Studio Display XDR，高端专业显示器，版本请微信确认。',
    description: '适合专业影像、设计和高端桌面工作流，具体配置和库存请微信确认。',
  ...
  },
  {
    ...
    optionGroups: [
      ...
      { name: '表带', values: ['运动表带', '回环式表带', '其他表带微信确认'] },
    ],
    shortDescription: 'Apple Watch Series 11，新款主力手表，尺寸和表带请微信确认。',
  ...
  },
  {
    ...
    optionGroups: [
      ...
      { name: '表带', values: ['海洋表带', '越野回环', '高山回环', '其他表带微信确认'] },
    ],
    shortDescription: 'Apple Watch Ultra 3，适合运动、户外和长续航需求。',
    description: '适合户外运动、健身、旅行和更高强度使用场景，表带组合请微信确认。',
  ...
  },
  {
    ...
    optionGroups: [
      { name: '版本', values: ['标准包装'] },
      { name: '需求', values: ['自用', '送礼', '批量询价'] },
    ],
    shortDescription: 'AirPods Pro 3，主动降噪耳机，库存和价格请微信确认。',
  ...
  },
  {
    ...
    shortDescription: 'AirPods Max 2，新款头戴式耳机，颜色和库存请微信确认。',
    description: '适合降噪、影音、学习和长时间佩戴，颜色库存请微信确认。',
  ...
  },
  {
    ...
    description: '适合日常通勤、上课和轻运动使用，版本和库存请微信确认。',
    reminder: '请确认版本、包装和库存，价格以微信确认为准。',
  },
  {
    ...
    shortDescription: 'Apple Vision Pro 新款，容量、头带和镜片需求请微信确认。',
  ...
  },
  {
    ...
    description: '适合 Apple TV、AirPlay、影音娱乐和家庭电视使用，容量和版本请微信确认。',
  ...
  },
  {
    ...
    reminder: '音箱类请确认颜色、数量和库存，价格以微信确认为准。',
  },
  {
    ...
    description: '适合小空间音乐播放、Siri 和智能家居控制，颜色和数量可微信确认。',
