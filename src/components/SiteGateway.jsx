    ...
    <main className="min-h-screen bg-[#fbfaf7] text-slate-900">
      <section className="px-4 pb-5 pt-5">
        <div className="mx-auto max-w-screen-sm">
          <div className="rounded-[28px] border border-slate-200 bg-gradient-to-br from-white via-[#fbfaf7] to-[#f4efe6] px-4 py-6 shadow-sm">
          ...
          {entries.map((entry) => {
            ...
            return (
              <button
                ...
                className="overflow-hidden rounded-2xl border border-slate-200 bg-white text-left shadow-sm transition active:scale-[0.99]"
              >
                ...
                <div className="p-4">
                  ...
                  <div className="mt-4 inline-flex h-11 items-center gap-2 rounded-full bg-slate-950 px-4 text-sm font-semibold text-white">
                    {entry.buttonText}
      ...
      <section className="px-4 pb-10 pt-4">
        <div className="mx-auto max-w-screen-sm rounded-2xl bg-white p-4 ring-1 ring-slate-200">
