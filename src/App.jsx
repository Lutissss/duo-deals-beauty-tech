...
const siteConfigs = {
  ...
  market: {
    ...
    sectionLabel: '日用百货',
    eyebrow: '日用百货专区',
    heroTitle: '饮用水 / 饮料 / 零食 / 个护 / 清洁 / 纸品，本地顺手补货',
    description: '本区提供饮用水、饮料、零食、方便速食、个人护理、纸品和清洁用品。页面标价就是免税到手价；送货上门满 $60 起送，WashU 附近线下自提不限金额。',
    categories: ['全部', '饮用水', '饮料', '零食', '方便速食', '个人护理', '日用纸品', '洗衣清洁', '厨房清洁', '现货', '预订'],
